...
<body>
    ...
    <main class="todo">
        ...
        <div class="cards">
        <?php
        // Generar dinámicamente las cards para cada conjunto obtenida de la base de datos
        while($conjunto = mysqli_fetch_array($resultConjuntos)) { ?>
            <article class="card">
                <div class="foto">
                    <img src="<?php echo $conjunto['imagen']; ?>">
                </div>

                <h2><b><?php echo $conjunto['nombre']; ?></b></h2>
                <p class="descripcion">$<?php echo number_format($conjunto['precio'], 2); ?></p>
                
                <a href="../php/producto.php?id_producto=<?php echo $conjunto['id_producto']; ?>">
