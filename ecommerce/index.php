...
<header class="sticky-header">
  ...
  <div class="secciones">
    ...
    <div class="contenedor_carousel">
        <div id="carouselExample" class="carousel slide">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="imagenes/imagenes carousel/E-commerce.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="imagenes/imagenes carousel/E-commerce2.png" class="d-block w-100" alt="...">
              </div>
            </div>
        ...
        <h2 class="h2">Productos mas buscados</h2>
        <div style="width: 100%; !important" class="cards">
            <article class="card">
                <div class="foto">
                    <img src="imagenes/imagenes zapatillas/zapatillas.jpg" alt="">
                </div>
                <h2><b>Zapatillas</b></h2>
                <p class="descripcion">Desde $23.000</p>
                <a href="vista zapatillas/zapatillas.php"><p class="titulo-secciones">VER MAS</p></a>
            </article>

            <article class="card">
                <div class="foto">
                    <img src="imagenes/imagenes conjuntos/conjuntos.jpg" alt="">
                </div>
                <h2><b>Conjuntos</b></h2>
                <p class="descripcion">Desde $35.000</p>
                <a href="vista conjuntos/conjuntos.php"><p class="titulo-secciones">VER MAS</p></a>
            </article>

            <article class="card">
                <div class="foto">
                    <img src="imagenes/imagenes remeras/remeras.jpg" alt="">
                </div>
                <h2><b>Remeras</b></h2>
                <p class="descripcion">Desde $9.800</p>
                <a href="vista remeras/remeras.php"><p class="titulo-secciones">VER MAS</p></a>
            </article>          
        </div>
        ...
        <footer>           
                ...
                <p>Correo:  ownstylecb@gmail.com</a></p>      
